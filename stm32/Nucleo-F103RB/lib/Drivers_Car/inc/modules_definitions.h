...
/**
 * @brief       Maximum value accepted by the Motor_setSpeed function in forward direction
*/
#define MAX_SPEED_FOR                        		((float)1.)

/**
 * @brief       Maximum value accepted by the Motor_setSpeed function in backward direction
*/
#define MAX_SPEED_BAC                        		((float)-1.)

	
/**
 * @brief       Zero angle value used to put the wheel straight
*/
#define MOTORS_ANGLE_ZERO                         133
...
/**
 * @brief       Maximum current for the rear motors (mA)
*/
#define MAX_CURRENT                                 ((float)1000.0)
	
/**
 * @brief       Maximum current for the front motors (mA)
*/
#define FRONT_MOTOR_MAX_CURRENT                     ((float)200.0)    
