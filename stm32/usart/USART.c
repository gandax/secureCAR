/**
  ...
  * @version V1.1.1
  * @date    07-april-2013
  * @brief   Routines and interrupts for the USART bus
	* @modif   Thomas Gandou
  ******************************************************************************
  * @attention
  *
  * <h2><center>&copy; COPYRIGHT 2013 chengsun</center></h2>
  *
	*           https://github.com/chengsun/stm32f3-robotics
  ******************************************************************************
  */
...
/**
  * @brief  Initialization of the USART1
  * @param  None
  * @retval None
  */
...
/**
  * @brief  Routine interrupt for the USART 
  * @param  None
  * @retval None
  */
...
/**
  * @brief  Send one single character through the USART
  * @param  None
  * @retval None
  */
...
/**
  * @brief  Send a string of size len through USART bus
  * @param  None
  * @retval None
  */
...
/**
  * @brief  Send any string through the USART bus
  * @param  None
  * @retval None
  */
...
/**
  * @brief  Send a character instantly through the USART bus
  * @param  None
  * @retval None
  */
